                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <h1 className={styles.chatEmptyStateTitle}>Chattbotten</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Baserat på Maskinentreprenörernas handbok</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder='Skriva en ny fråga (exempelvis "vad är en laglig vikt på väg")'
                            disabled={isLoading}
